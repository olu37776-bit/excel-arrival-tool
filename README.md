...
1. [直接下载 ExcelRevenueTool-v0.8.7.exe](https://github.com/olu37776-bit/excel-arrival-tool/releases/download/v0.8.7/ExcelRevenueTool-v0.8.7.exe)。
2. 双击 `ExcelRevenueTool-v0.8.7.exe`。不需要安装 Python，也不需要运行 BAT 或打开终端。
