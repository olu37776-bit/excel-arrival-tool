...
class DesktopFormTest(unittest.TestCase):
    ...
    def test_no_month_selection_and_visible_actions(self):
        app = RevenueApp(self.root, CONFIG)
        self.root.update()
        self.assertFalse(hasattr(app, 'months'))
        self.assertFalse(hasattr(app, 'year'))
    ...
    def test_background_generation_keeps_ui_responsive_and_restores_controls(self):
        ...
        def runner(**kwargs):
            ...
            return SimpleNamespace(output_path=Path(kwargs['output_path']), base_count=7, issue_count=1, report_months=('2026-08', '2026-09'))
        ...
        with TemporaryDirectory() as tmp:
            ...
            self.assertNotIn('report_month', received[0])
